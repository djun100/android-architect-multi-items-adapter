package com.example.listviewdemo.demo2.activity;
...
import com.example.listviewdemo.demo2.adapter.Demo2Adapter;
...
public class Demo2Activity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setAdapter(new Demo2Adapter(Demo2Activity.this,getDemoBean()));
	}
